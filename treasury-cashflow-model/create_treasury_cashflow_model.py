...
def build_workbook():
    ...
    instruments = [
        ["Bond A", "ID-A", date(2026, 11, 19), 500_000_000, 8_750_000],
        ["Bond B", "ID-B", date(2027, 9, 15), 475_000_000, 9_500_000],
        ["Bond C", "ID-C", date(2034, 5, 14), 300_000_000, 8_250_000],
    ]
    ...
    payment_header_row = 15
    payment_start_row = 16
    payment_end_row = 140
    ...
    for r in range(1, max(row, holiday_end_row) + 1):
