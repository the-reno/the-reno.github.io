...
def main():
    ...
    mo.Range("B6").Formula = '=RBuildCurve("curve1",DATE(2026,6,15),DATE(2030,12,31),3.80,INPUTS!D4:E7,INPUTS!A4:B9)'
    mo.Range("A6").Value = "Curve"

    rows = [
        (9,  "Period simple",   '=RAccrue(DATE(2026,7,1),DATE(2026,10,1),100,"SIMPLE",$B$6)',   0.853750),
        (10, "Period compound", '=RAccrue(DATE(2026,7,1),DATE(2026,10,1),100,"COMPOUND",$B$6)', 0.857325),
        (13, "Swap FIXED", '=RSwapLeg(DATE(2026,7,1),DATE(2026,8,1),375,3.15,$B$6,"FIXED")', 1.017187),
        (14, "Swap FLOAT", '=RSwapLeg(DATE(2026,7,1),DATE(2026,8,1),375,3.15,$B$6,"FLOAT")', 1.142773),
        (15, "Swap NET",   '=RSwapLeg(DATE(2026,7,1),DATE(2026,8,1),375,3.15,$B$6,"NET")',  -0.125585),
    ]
    ...
    mo.Range("B18").Formula = "=RBuildCurve("info",$B$6,$B$6,0,$B$6,$B$6)"
