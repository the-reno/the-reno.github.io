...
def build(path="NII_Engine_v2.xlsx"):
    ...
    for nm,exp,f in [("FIXED leg",1.017187,'=SWAP(DATE(2026,7,1),DATE(2026,8,1),375,3.15,$B$6,"FIXED")'),
    ("FLOAT leg",1.142773,'=SWAP(DATE(2026,7,1),DATE(2026,8,1),375,3.15,$B$6,"FLOAT")'),
    ("NET",-0.125585,'=SWAP(DATE(2026,7,1),DATE(2026,8,1),375,3.15,$B$6,"NET")')]:
        put(ws,r,1,nm); x=put(ws,r,2,None,fill=YEL,box=True); x.number_format="0.000000"
        put(ws,r,3,exp,nf="0.000000"); put(ws,r,4,'=IF(ABS(B%d-C%d)<0.000001,"OK","check")'%(r,r),SUB)
        put(ws,r,5,f,MONO); r+=1
