const LENGTH_RATIOS=Object.freeze({head:.135,torso:.288,pelvis:.11,upperArm:.186,forearmHand:.244,thigh:.245,lowerLeg:.246,foot:.152});
const MASS_PERCENT=Object.freeze({head:8,torso:31.68,pelvis:12.32,upperArm:2.75,forearmHand:2.25,thigh:11.02,lowerLeg:6.08,foot:1.9});
